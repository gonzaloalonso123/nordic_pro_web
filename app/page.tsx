    ...
    <div className="max-w-7xl mx-auto">
      <div
        className={`flex flex-col md:flex-row justify-between items-start md:items-center ${
          isMobile ? "px-4 pt-4 pb-2" : "mb-6 gap-4"
        }`}
      >
        <div>
          <h1
      ...
      {isMobile && (
        <div className="flex gap-2 px-4 overflow-x-auto pb-4 no-scrollbar">
          <Button className="flex items-center gap-2 rounded-full bg-primary whitespace-nowrap">
            <CheckCircle className="h-4 w-4" />
            <span>Team Check-in</span>
          </Button>
          <Button
      ...
      >
        ...
        <Card className={isMobile ? "shadow-sm" : ""}>
          ...
          <CardContent>
            ...
            <Button
              variant="link"
              className="p-0 h-auto mt-2 text-primary flex items-center"
            >
              View calendar
      ...
      <div
        className={`grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 ${
          isMobile ? "px-4 mt-4" : "mb-6"
        }`}
      >
        <Card className={`lg:col-span-2 ${isMobile ? "shadow-sm" : ""}`}>
          <CardHeader
            className={`${
              isMobile ? "pb-0" : ""
          ...
          >
            <div>
              ...
              <CardDescription>
                Average mood score over the past 30 days
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent className={`${isMobile ? "px-2 pt-0" : "px-2 sm:px-6"}`}>
            <TeamMoodChart />
          </CardContent>
        </Card>
            ...
            <Tabs defaultValue="all">
              <div className="flex items-center justify-between">
                ...
                <TabsList className={isMobile ? "h-8" : ""}>
                  <TabsTrigger
                    value="all"
                    className={isMobile ? "text-xs px-2.5 h-7" : ""}
                  >
                    All
                  </TabsTrigger>
                  <TabsTrigger
      ...
      <div className={`mt-4 mb-6 ${isMobile ? "px-4" : "mt-6"}`}>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 mb-2">
                  3 players have reported low mood scores for 3 consecutive
                  days. Consider checking in with them.
                </p>
                <Button
                  size="sm"
                  variant="outline"
