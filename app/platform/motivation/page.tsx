    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-gray-500">Gamified challenges and rewards to keep players engaged</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Active and upcoming challenges for your team</CardDescription>
          </CardHeader>
          <CardContent>
            <TeamChallenges />
          </CardContent>
